...
fun MainPage() {
    ...
    var selectButton by remember { mutableStateOf("") }
    ...
    Scaffold(
        ...
        ConstraintLayout(
            ...
            Button(
                onClick = {
                    selectButton = "red"
                    infoText = "연락처에 등록된 번호 외에 전화를 다 차단합니다."
                },
                shape = CircleShape,
                colors = ButtonDefaults.buttonColors(
                    containerColor = if (selectButton == "red") Color(0xFFFF5F57) else Color(0xFF67413E)
                ),
                modifier = Modifier
                    .size(circleSize)
                    .constrainAs(red) {
            ...
            Button(
                onClick = {
                    selectButton = "yellow"
                    infoText = "연락처와 OOO회원 외에 모든 번호를 차단합니다."

                },
                shape = CircleShape,
                colors = ButtonDefaults.buttonColors(
                    containerColor = if (selectButton == "yellow") Color(0xFFFEBC2E) else Color(0xFF554720)
                ),
                modifier = Modifier
                    .size(circleSize)
                    .constrainAs(yellow) {
            ...
            Button(
                onClick = {
                    selectButton = "green"
                    infoText = "스팸 등록된 번호만 차단합니다"

                },
                shape = CircleShape,
                colors = ButtonDefaults.buttonColors(
                    containerColor = if (selectButton == "green") Color(0xFF26C940) else Color(0xFF3A5A3A)
                ),
                modifier = Modifier
                    .size(circleSize)
                    .constrainAs(green) {
